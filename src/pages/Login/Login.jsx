...
export default function Login() {
  ...
  function humanError(err) {
    ...
    if (code.includes("email-already-in-use")) return "Email already exists. Try logging in.";
    if (code.includes("user-not-found")) return "User not found.";
    if (code.includes("wrong-password") || code.includes("invalid-credential"))
      return "Wrong email or password.";
    if (code.includes("network-request-failed")) return "Network error. Check your internet.";
    ...
    <div style={S.page}>
      ...
      >
        ...
        <div style={S.card}>
          ...
          <div style={S.title}>{isLogin ? "Login" : "Create account"}</div>
          ...
          <div style={S.bottomSwitch}>
            ...
            <div style={S.small}>Tip: minimum password is 6 characters.</div>
          </div>
        </div>
      </div>
    </div>
